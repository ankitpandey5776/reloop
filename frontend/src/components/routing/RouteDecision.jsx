...
const OTHER_DECISIONS = {
  ...
  REFURBISH: {
    ...
    desc: 'A nearby repair partner will restore it to near-new in 2–3 days, then it enters the marketplace.',
      ...
      <div className={`rounded-2xl p-5 ${cfg.bg} border border-gray-100 dark:border-gray-800`}>
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1 leading-relaxed">{cfg.desc}</p>
          </div>
        </div>
      </div>
